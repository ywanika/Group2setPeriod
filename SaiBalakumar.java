 ...
 */
public class SaiBalakumar extends Student implements SpecialInterestOrHobby
{
     ...
     * 
     */
    public SaiBalakumar(String f, String l, int r, int s) {
        firstName=f;
        lastName=l;
        myRow=r;
        mySeat=s;
        ...
        if(Greenfoot.mouseClicked(this)){
          //  if (sitting){
            ...
            // Call the sitDown() method to move back  to your seat
                ...
                teleport();  // Kilgore Trount's special method... Please write one of your own. You can use this, but please modify it and be creative.
                provideLesson();
                sitDown();
            }
    ...
    public void teleport(){
        ...
        for (int i=1;i<=9;i++){
            setImage("smoke.jpg");
            setLocation(Greenfoot.getRandomNumber(9), Greenfoot.getRandomNumber(5));
            Greenfoot.delay(10);
            setImage(standingFile);
            Greenfoot.delay(15);
        }
