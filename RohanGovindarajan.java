 ...
 */
public class RohanGovindarajan extends Student implements SpecialInterestOrHobby
{
    ...
    public void act() 
    {
          ...
          //  if (sitting){
               ...
               //You can twirl your image, resize it, move it around, change transparancy, or a 
            // combination of all of those types of actions, or more. 
            //Make sure to save the original image if you manipulate it, so that you can put it back.
    ...
    public void provideLesson(){
        ...
        WhiteBoard board=getBoard();
        board.showBoard();
        moveToFront();
        String nextSlide=q=Greenfoot.ask("Next Slide (y/n)");
        }
        else {
          WhiteBoard board = getBoard();
          board.showBoard();
