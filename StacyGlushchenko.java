 ...
 */
public class StacyGlushchenko extends Student implements SpecialInterestOrHobby
{

    /**
     * Constructor for the StacyGlushchenko class.
     ...
     * 
     */
    public StacyGlushchenko(String f, String l, int r, int s) {
        firstName=f;
        lastName=l;
        myRow=r;
        mySeat=s;
