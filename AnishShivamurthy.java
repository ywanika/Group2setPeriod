 ...
 * 
 * @author Anish Shivamurthy
 * @version 2.0 Aug 13, 2019
 * @version 3.0 July 21, 2020
 */
public class AnishShivamurthy extends Student implements SpecialInterestOrHobby
{
     ...
     * of the classroom.
     */
    public AnishShivamurthy() {
        firstName="Anish";
        lastName="Shivamurthy";
        myRow=1;
        mySeat=1;
    ...
    public void act() 
    {
        ...
        if(Greenfoot.mouseClicked(this)){
          //  if (sitting){
                ...
                myHobby("I like to play video games! I have one sister.");
