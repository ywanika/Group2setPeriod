 ...
 */
public class TameemSaydi extends Student implements SpecialInterestOrHobby
{

    /**
     * Constructor for the TameemSaydi class.
     ...
     * 
     */
    public TameemSaydi(String f, String l, int r, int s) {
        firstName=f;
        lastName=l;
        myRow=r;
        mySeat=s;
    ...
    public TameemSaydi() {
     ...
     /**
     * Act - do whatever the TameemSaydi actor wants to do. This method is called whenever
    ...
    public void provideLesson(){
        ...
        if (q.contains("yes")){
        bluej.utility.Utility.openWebBrowser("https://drive.google.com/drive/shared-with-me");
